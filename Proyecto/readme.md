...
¿Qué hace?
    ...
    Toma un PDF y lo divide en fragmentos (chunks)
    Convierte cada fragmento en un vector numérico (embedding)
    Guarda los vectores en PostgreSQL + pgvector
    Cuando haces una pregunta, busca los fragmentos más relevantes y se los pasa a un LLM para que responda
...
Solo necesitás tener instalado:
    ...
    Docker Desktop: Para mayor detalle de la instalación, consultar con la documentación de Docker https://docs.docker.com/desktop/
